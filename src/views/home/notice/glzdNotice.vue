					...
					<div style="margin-top: 10px;" v-for="(item, index) in gongGao.slice((currentPage- 1)*pageSize,currentPage*pageSize)">
						<div style="padding: 0px 20px">
							...
							<div style="display: none;">
								<div class="biao-tiglzd" v-for="ite in item.srcList" style="margin-right: 5px;">
									<el-image 
...
<script>
	...
	export default {
	  ...
	  data(){
		...
		methods:{
			jsj(){
				axios.get('http://192.168.10.120:89/glzd',{
			...
			biao_ti(item,index){
				...
				document.querySelector(".biao-tiglzd").firstChild.firstChild.click()
